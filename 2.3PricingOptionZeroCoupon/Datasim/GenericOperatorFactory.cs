...
public static class GenericOperatorFactory<TLeft, TRight, TResult, TOwner>
{
    ...
    public static BinaryOperatorT<TLeft, TRight, TResult> Divide
    {
        get
        {
            ...
            {
                //Create a dynamic method and an intermediate language generator
                DynamicMethod method = new DynamicMethod("op_Division", typeof(TResult),
                    new Type[] {typeof(TLeft), typeof(TRight)}, typeof(TOwner));
                ILGenerator generator = method.GetILGenerator();
                ...
                if (typeof(TLeft).IsPrimitive)
                {
                    //Divide the 2 arguments and push the result on the evaluation stack
                    generator.Emit(OpCodes.Div);
                }
                else
                {
                    MethodInfo info =
                        typeof(TLeft).GetMethod("op_Division", new Type[] {typeof(TLeft), typeof(TRight)}, null);
                    generator.EmitCall(OpCodes.Call, info, null);
                }
                ...
                //Finish dynamic method and create a delegate
                divide =
                    (BinaryOperatorT<TLeft, TRight, TResult>) method.CreateDelegate(
                        typeof(BinaryOperatorT<TLeft, TRight, TResult>));
            }
